...
function response(dummy) {
  ...
  switch (dummy) {
    case 'b1':
      document.querySelector('.img1').setAttribute('src', 'Images/happy.png');
      ...
      break;
    case 'b2':
      document.querySelector('.img1').setAttribute('src', 'Images/sad.png');
      ...
      break;
    case 'b3':
      document.querySelector('.img1').setAttribute('src', 'Images/thinking.png');
      ...
      break;
    case 'b4':
      document.querySelector('.img1').setAttribute('src', 'Images/cool.png');
      ...
      break;
    case 'b5':
      document.querySelector('.img1').setAttribute('src', 'Images/party.png');
    ...
    case 'b6':
      ...
      break;
    case 'b7':
      document.querySelector('.img1').setAttribute('src', 'Images/laugh.png');
    ...
    case 'b8':
      ...
      break;
    case 'b9':
      document.querySelector('.img1').setAttribute('src', 'Images/smile.png');
      ...
      break;
    case 'b10':
      document.querySelector('.img1').setAttribute('src', 'Images/silly.png');
...
// (document.getElementsByName('button')[1].click===true){
//   document.querySelector('.img1').setAttribute('src','Images/party.png');
// }
